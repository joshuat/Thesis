...
In order to produce the electrons Rubidium atoms from an oven are first slowed using a Zeeman slower which consists of a near-resonant laser beam and a tapered magnetic coil. The Zeeman slower slows the atoms leaving the oven from speeds of order 300m/s to speeds of order 10m/s which corresponds to temperatures of a few Kelvin.
