...
\begin{tikzpicture}[scale=2]
    ...
    \end{scope}
\end{tikzpicture}
\caption[Title]{An amazing caption of justice. Also fix e- postion.}
\end{figure}



has photons resonant to the excited transition to the continuum ($\sim$480nm). {\color{red} is there a better way to phrase this?} 
