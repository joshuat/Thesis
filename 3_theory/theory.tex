...
\Gls{mot} make use of a closed transition of rubidium in order to trap atoms into an atomic cloud. \Glspl{odt} and absorption imaging also interact with this transition. The various energy levels and transitions involved are shown in figure \ref{fig:energy_levels}.
