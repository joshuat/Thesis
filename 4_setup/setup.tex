...
The first stage of the experiment is trapping rubidium atoms in a magneto-optic trap. An oven is used to create Rubidium vapour with a temperature around 350K which is collimated and directed down the axis of the Zeeman slower. The Zeeman slower slows the atoms down such that when they reach the main chamber they can be trapped by the combined magnetic and optical traps.
...
Atoms in a rubidium reservoir are heated to approximately $80\,^{\circ}\mathrm{C}$ in the oven. The resulting vapour effuses through a heated drift tube and is then incident on a `cold-cup'' aperture resulting in a collimated beam. At this point the atoms have a velocity in the region of 300m/s. The oven is shown in figure \ref{fig:oven}
